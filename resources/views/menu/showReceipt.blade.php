...
<head>
    ...
    <title>Coffee App - Receipt - SaleID : {{$sale->id}}</title>
...
<body>
    <div id="wrapper">
        <div id="receipt-header">
            <h3 id="resturant-name">Coffee With Yoffee</h3>
            <p>Address: Sami Shamoon 14 st.</p>
            <p>Tel-Aviv, MD 1234</p>
            <p>Tel: 08-XXXX-XXXX</p>
