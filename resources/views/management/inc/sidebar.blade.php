<div class="col-md-4">
    <div class="list-group ">
        ...
        <a href="/management/menu" class="list-group-item list-group-item-action"><i class="fas fa-mug-hot"></i> Menu</a>
        <a href="/management/table" class="list-group-item list-group-item-action"><i class="fas fa-chair"></i> Table</a>
        <a href="/management/user" class="list-group-item list-group-item-action"><i class="fas fa-user-edit"></i> User</a>
    </div>
</div>